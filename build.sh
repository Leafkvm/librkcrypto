...
CROSS_COMPILE32=${CROSS_COMPILE32:-$TOOLCHAIN_PREBUILTS/$TOOLCHAIN_PATH_ARM32/arm-none-linux-gnueabihf-gcc}
CROSS_COMPILE64=${CROSS_COMPILE64:-$TOOLCHAIN_PREBUILTS/$TOOLCHAIN_PATH_AARCH64/aarch64-none-linux-gnu-gcc}
CROSS_COMPILE32_GXX=${CROSS_COMPILE32_GXX:-$TOOLCHAIN_PREBUILTS/$TOOLCHAIN_PATH_ARM32/arm-none-linux-gnueabihf-g++}
CROSS_COMPILE64_GXX=${CROSS_COMPILE64_GXX:-$TOOLCHAIN_PREBUILTS/$TOOLCHAIN_PATH_AARCH64/aarch64-none-linux-gnu-g++}
